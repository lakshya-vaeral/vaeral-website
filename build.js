...
${FORM_FOCUS_CSS}
  ...
  /* --- Team wheel on desktop ---------------------------------------------------------------
     ...
     screen the more empty room sat between the two. Let the wheel take that room: 40px off the
     heading, 110px off the right edge, never under 600px (the 1280 layout, where it already meets
     the heading) or over 840px. The section follows the wheel's height instead of holding the
     export's fixed 789px, and past 1604px the spare room splits evenly around the wheel rather
  ...
  @media (min-width: 1280px) {
    ...
    .framer-ofgoy .framer-un4g3d-container {
      --wheel: clamp(600px, 100vw - 764px, 840px);
      width: var(--wheel);
      height: var(--wheel);
    }
  }
